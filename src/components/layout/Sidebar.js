...
import { Map, CloudUpload, Edit, Settings, TableChart, Code, ModelTraining } from '@mui/icons-material';
...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { path: '/snippetwriter', name: 'Snippet Writer', icon: <Code /> },
        { path: '/datacanvas', name: 'DataCanvas', icon: <ModelTraining /> },
